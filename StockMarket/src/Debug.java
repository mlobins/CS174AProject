...
*/
	...
	public static void initStocks() {
		...
		Communications.setStocks(1, "124", 0, 5);
		
		Communications.setActorDirectorProfile("JOHN1", 2015);
		Communications.setStocks(2, "125", 0, 5);
		
		Communications.setActorDirectorProfile("JOHN2", 2015);
		Communications.setStocks(3, "126", 0, 5);
		
		Communications.setActorDirectorProfile("JOHN3", 2015);
		Communications.setStocks(4, "127", 0, 5);
		
		Communications.setActorDirectorProfile("JOHN4", 2015);
		Communications.setStocks(5, "128", 0, 5);
		Communications.setContract(1, "THE BIG HOY 0", "role", 2017, 666);
		Communications.setContract(2, "THE BIG HOY 1", "role", 2018, 666);
		Communications.setContract(3, "THE BIG HOY 2", "role", 2019, 666);
		Communications.setContract(3, "THE BIG HOY 3", "role", 2016, 666);
		Communications.setContract(4, "THE BIG HOY 4", "role", 2015, 666);
		Communications.setContract(4, "THE BIG HOY 5", "role", 2014, 666);
		Communications.setContract(4, "THE BIG HOY 6", "role", 2013, 666);
		Communications.setContract(5, "THE BIG HOY 7", "role", 2012, 666);
		Communications.setContract(5, "THE BIG HOY 8", "role", 2011, 666);
	}
