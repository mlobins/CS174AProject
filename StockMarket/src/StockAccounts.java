...
public class StockAccounts {
	...
	public String toString() {
		...
		return "StockAccounts [account_sid=" + account_sid + ", stock_id=" + stock_id + ", balance="
				+ balance + ", buying_price=" + buying_price + ", selling_price=" + selling_price
				+ ", transID=" + transID + ", username=" + username + "]";
	}		
}
